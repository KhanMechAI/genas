...
data_dir = Path(r"G:\OneDrive - UNSW\University\Postgraduate\Year 3 Trimester 2\COMP9417\Major Project\src\runs")
...
grid = torchvision.utils.make_grid(images).to(device).cuda(device)
